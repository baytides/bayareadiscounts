...
export const programs: ProgramTranslations = {
  ...
  'hip-housing-home-sharing': {
    ...
    what_they_offer:
      '- Free housing matching service\n- Background checks included\n- Compatibility screening\n- Connects homeowners and renters\n- Affordable housing option\n- Ongoing support and mediation',
    how_to_get_it:
      '1. Contact HIP Housing\n2. Complete application and interview\n3. Undergo background screening\n4. Receive compatible matches\n5. Meet potential housemates\n6. Finalize housing arrangement',
    timeframe: 'Ongoing',
    link_text: 'Apply',
  },
  'lifemoves-services': {
  ...
  'cid-housing-modifications': {
    name: 'Housing Accessibility Modifications Program',
    description:
    ...
    how_to_get_it:
      '1. Contact CID San Mateo\n2. Complete application process\n3. Demonstrate disability or age eligibility\n4. Home assessment conducted\n5. Modifications approved and scheduled\n6. Work completed at no cost',
    timeframe: 'Ongoing',
    link_text: 'Apply',
  },
  'echo-housing': {
    ...
    what_they_offer:
      '- Housing discrimination investigation\n- Fair housing complaint filing\n- Housing counseling services\n- Tenant rights education\n- Landlord compliance assistance\n- Legal referrals when needed',
    how_to_get_it:
      '1. Contact ECHO Housing\n2. Describe your housing situation\n3. File complaint if discrimination occurred\n4. Investigation conducted\n5. Receive assistance and resources\n6. Legal action if warranted',
    timeframe: 'Ongoing',
    link_text: 'File Complaint',
  },
  'smc-fixit-clinics': {
    name: 'Fixit Clinics',
    description:
  ...
  'smc-refuel-your-fun': {
    ...
    what_they_offer:
      '- Discounted propane refills\n- For reusable cylinders\n- Alternative to single-use 1 lb. cylinders\n- Reduces waste\n- Saves money on propane\n- Environmentally friendly option',
    how_to_get_it:
      '1. Get reusable propane cylinder\n2. Find participating refill location\n3. Bring empty cylinder\n4. Receive discounted refill\n5. Reuse cylinder for camping/grilling\n6. Return for future refills',
    timeframe: 'Ongoing',
    link_text: 'Learn More',
  },
  ...
  'acs-discovery-shop-los-altos': {
    ...
    description:
      'The American Cancer Society Discovery Shop in Los Altos is a thrift store selling quality secondhand and vintage items, with proceeds supporting cancer research and patient programs. Seniors 55+ receive 10% off on Tuesdays.',
    what_they_offer:
      '- Accept clothing donations\n- Accept accessories and housewares\n- Accept linens and furniture\n- Accept collectibles and vintage items\n- Affordable thrift shopping\n- Proceeds fund cancer research',
    how_to_get_it:
      '1. Visit the Discovery Shop at 243 Main St, Los Altos\n2. Donate gently used items\n3. Or shop for affordable goods\n4. Open Mon-Sat 10am-6pm, Sun 10am-5pm\n5. Call (650) 949-0505 for info',
    timeframe: 'Ongoing',
    link_text: 'Visit Store',
  },
  ...
  'acs-discovery-shop-menlo-park': {
    ...
    description:
      'The American Cancer Society Discovery Shop in Menlo Park is a thrift store selling quality secondhand and vintage items, with proceeds supporting cancer research and patient programs. Military receive 10% off any day; seniors 55+ receive 10% off on Tuesdays.',
    what_they_offer:
      '- Accept clothing donations\n- Accept accessories and housewares\n- Accept linens and furniture\n- Accept collectibles and vintage items\n- Affordable thrift shopping\n- Proceeds fund cancer research',
    how_to_get_it:
      '1. Visit the Discovery Shop at 748 Santa Cruz Ave, Menlo Park\n2. Donate gently used items\n3. Or shop for affordable goods\n4. Open Mon-Sat 10am-6pm, Sun 10am-5pm\n5. Call (650) 325-8939 for info',
    timeframe: 'Ongoing',
    link_text: 'Visit Store',
  },
  ...
  'sf-lgbt-center': {
    ...
    what_they_offer:
      '- Trans Employment Program (job training and placement)\n- Immigration legal services and DACA support\n- Financial assistance programs\n- Youth programs and services\n- Community events and cultural programming\n- Meeting space for LGBTQ+ organizations\n- Senior services and activities',
    how_to_get_it:
      '1. Visit the SF LGBT Center in person or online\n2. Check program eligibility requirements\n3. Register for services or programs\n4. Some services require appointments\n5. Drop-in services also available',
    timeframe: 'Ongoing',
  ...
  'oakland-lgbtq-center': {
    ...
    what_they_offer:
      '- Free support groups and peer counseling\n- Senior services and activities\n- Youth drop-in programs\n- Wellness clinic services\n- Housing assistance resources\n- Addiction recovery support\n- Community events (open mic, gaming nights, drag shows)',
    how_to_get_it:
      '1. Visit the center during open hours\n2. Check website for event schedule\n3. Join support groups (no registration needed)\n4. Access drop-in services\n5. Apply for specific programs as needed',
    timeframe: 'Ongoing',
    link_text: 'Visit Center',
  },
  'pacific-center': {
    ...
    what_they_offer:
      '- Low-cost individual, couples, and family therapy\n- Therapy for polyamorous relationships\n- Support for partners of trans/gender-nonconforming individuals\n- Youth drop-in programs\n- Senior programming and social groups\n- Peer support groups\n- Sliding scale fees available',
    how_to_get_it:
      '1. Call or visit the Pacific Center\n2. Schedule intake appointment for therapy\n3. Drop in for support groups and events\n4. Fees based on sliding scale\n5. No one turned away for inability to pay',
    timeframe: 'Ongoing',
  ...
  'rainbow-community-center': {
    ...
    how_to_get_it:
      '1. Visit the Rainbow Community Center\n2. Walk in for HIV testing (no appointment needed)\n3. Register for counseling services\n4. Join support groups and programs\n5. Check website for event schedule',
    timeframe: 'Ongoing',
    link_text: 'Get Help',
  },
  'billy-defrank-center': {
    ...
    how_to_get_it:
      '1. Visit the center during open hours\n2. Walk in for services\n3. Schedule HIV testing\n4. Join groups and programs\n5. Check website for event calendar',
    timeframe: 'Ongoing',
    link_text: 'Visit Center',
  },
  'spahr-center': {
    ...
    what_they_offer:
      '- Free HIV testing and prevention services\n- HIV support groups\n- Youth drop-in groups\n- Senior discussion groups\n- Social mixers and events\n- Resource referrals\n- Community workshops',
    how_to_get_it:
      '1. Visit The Spahr Center in San Rafael\n2. Check website for group schedules\n3. Walk in for HIV testing\n4. Join programs and events\n5. Call for resource referrals',
    timeframe: 'Ongoing',
    link_text: 'Get Services',
  },
  'lgbtq-connection-napa': {
    name: 'LGBTQ Connection',
    description:
    ...
    how_to_get_it:
      '1. Visit LGBTQ Connection in Napa\n2. Check website for events and programs\n3. Register for trainings and workshops\n4. Join community gatherings\n5. Participate in leadership programs',
    timeframe: 'Ongoing',
    link_text: 'Get Connected',
  },
  'queer-lifespace': {
    ...
    what_they_offer:
      '- Low-fee individual therapy\n- Substance abuse counseling\n- Group therapy sessions\n- Couples counseling\n- Sliding scale fees (some as low as $20)\n- LGBTQ+-affirming therapists',
    how_to_get_it:
      '1. Visit queerlifespace.org\n2. Complete intake form\n3. Schedule consultation\n4. Discuss fee based on income\n5. Begin therapy services',
    timeframe: 'Ongoing',
    link_text: 'Get Therapy',
  },
  'lyric-youth': {
    ...
    what_they_offer:
      '- Education enhancement programs\n- Career training and job placement\n- Health promotion and PrEP/HIV care\n- Housing navigation assistance\n- Leadership development\n- Drop-in youth services\n- Mental health support',
    how_to_get_it:
      '1. Visit LYRIC during drop-in hours\n2. Must be ages 12-24\n3. LGBTQQ+ youth and allies welcome\n4. Register for specific programs\n5. Walk-in services available',
    timeframe: 'Ongoing',
    link_text: 'Get Help',
  },
  'outlet-peninsula': {
    ...
    how_to_get_it:
      '1. Contact Outlet at your nearest location\n2. Schedule counseling appointment\n3. Join youth or parent support groups\n4. Services available for ages 13-25\n5. Family members welcome',
    timeframe: 'Ongoing',
    link_text: 'Find Location',
  },
  'api-wellness-transthrive': {
    ...
    what_they_offer:
      '- Primary care services\n- Free HIV and STD testing\n- PrEP prescriptions and support\n- TRANS:THRIVE drop-in care center\n- Support groups\n- Community outings and events\n- Trans-affirming healthcare',
    how_to_get_it:
      '1. Visit API Wellness or TRANS:THRIVE\n2. Walk in for HIV/STD testing\n3. Schedule appointment for primary care\n4. Drop in for TRANS:THRIVE services\n5. Join support groups and events',
    timeframe: 'Ongoing',
    link_text: 'Get Care',
  },
  'openhouse-sf': {
    ...
    how_to_get_it:
      '1. Contact Openhouse for services\n2. Apply for senior housing (waitlist may apply)\n3. Schedule case management intake\n4. Join social programs and activities\n5. Must be LGBTQ+ senior (typically 55+)',
    timeframe: 'Ongoing',
    link_text: 'Get Services',
  },
  'pflag-sf': {
    ...
    what_they_offer:
      '- Monthly support group meetings\n- Family support and education\n- LGBTQ+ advocacy resources\n- Speaker programs for schools/organizations\n- Connection to local resources\n- Virtual support options',
    how_to_get_it:
      '1. Visit pflagsf.org for meeting schedule\n2. Attend monthly support meetings\n3. Contact for individual support\n4. Request speakers for your organization\n5. Access online resources',
    timeframe: 'Ongoing',
  ...
  'trans-lifeline': {
    ...
    what_they_offer:
      '- 24/7 crisis hotline (staffed by trans people)\n- Emotional support during crisis\n- Microgrants for emergency needs\n- Name change assistance grants\n- Peer support connections\n- Resource referrals',
    how_to_get_it:
      '1. Call the Trans Lifeline hotline\n2. US: 877-565-8860\n3. Canada: 877-330-6366\n4. All operators are trans\n5. No police involvement without consent\n6. Apply for microgrants online',
    timeframe: 'Ongoing',
    link_text: 'Get Help',
  },
  'trevor-project': {
    ...
    what_they_offer:
      '- 24/7 crisis hotline (1-866-488-7386)\n- Text support (text START to 678-678)\n- Online chat support\n- TrevorSpace online community\n- Educational resources\n- Trained counselors for LGBTQ+ youth',
    how_to_get_it:
      '1. Call 1-866-488-7386 (24/7)\n2. Text START to 678-678\n3. Chat online at thetrevorproject.org\n4. Join TrevorSpace community\n5. For ages 13-24',
    timeframe: 'Ongoing',
    link_text: 'Get Help',
  },
  'lgbt-asylum-project': {
    ...
    what_they_offer:
      '- Free legal representation for asylum cases\n- Help preparing asylum applications\n- Court representation\n- Case management support\n- Connection to community resources\n- Pro bono attorney referrals',
    how_to_get_it:
      '1. Contact The LGBT Asylum Project\n2. Complete intake process\n3. Must be LGBTQ+ asylum seeker\n4. Cases handled by volunteer attorneys\n5. All services are free',
    timeframe: 'Ongoing',
    link_text: 'Get Legal Help',
  },
  'tgi-justice-project': {
    ...
    what_they_offer:
      '- Reentry support services\n- Advocacy for incarcerated trans/intersex people\n- Housing assistance\n- Legal name/gender marker changes\n- Community organizing\n- Mutual aid support',
    how_to_get_it:
      '1. Contact TGI Justice Project\n2. Currently or formerly incarcerated trans/intersex individuals welcome\n3. Receive reentry support\n4. Access advocacy services\n5. Join community programs',
    timeframe: 'Ongoing',
    link_text: 'Get Support',
  },
  'el-la-para-translatinas': {
    ...
    how_to_get_it:
      '1. Contact El/La Para TransLatinas\n2. Join community groups and events\n3. Access support services\n4. Participate in workshops\n5. Services in Spanish and English',
    timeframe: 'Ongoing',
    link_text: 'Get Support',
  },
  'glbt-historical-society': {
    ...
    what_they_offer:
      '- Free First Sundays (free admission monthly)\n- Regular admission only $10\n- Seniors, students, military: $7\n- LGBTQ+ history exhibitions\n- Research archives access\n- Educational programs\n- Community events',
    how_to_get_it:
      '1. Visit on First Sunday for free admission\n2. Or pay regular admission ($10, $7 reduced)\n3. Check website for current exhibitions\n4. Access archives by appointment\n5. Join educational programs',
    timeframe: 'Ongoing',
    link_text: 'Plan Visit',
  },
  'id-me-first-responders': {
    name: 'ID.me First Responder Discounts',
    description:
    ...
    what_they_offer:
      '- One-time identity verification\n- Access to many retailer discounts\n- 10-25% off at major brands\n- Tech discounts (Apple, Samsung, Dell)\n- Travel discounts (hotels, car rentals)\n- Entertainment and subscription savings',
    how_to_get_it:
      '1. Create free ID.me account\n2. Verify first responder status with credentials\n3. Upload employment verification if needed\n4. Once verified, access discounts through ID.me Shop\n5. Verification transfers across all participating retailers',
    timeframe: 'Ongoing',
    link_text: 'Verify Status',
  },
  'govx-first-responder': {
    name: 'GovX First Responder Discounts',
    description:
    ...
    what_they_offer:
      '- Up to 60% off major brands\n- Tactical and outdoor gear\n- Apparel and footwear\n- Electronics and tech\n- Travel and entertainment\n- Home and auto products',
    how_to_get_it:
      '1. Register at govx.com\n2. Verify first responder status\n3. Provide department or agency info\n4. Access exclusive member pricing\n5. Shop and save on every order',
    timeframe: 'Ongoing',
    link_text: 'Join Free',
  },
  'verizon-discounts': {
    name: 'Verizon Community Discounts',
    description:
      'Verizon offers ongoing monthly discounts on unlimited wireless plans for military, veterans, first responders, teachers, and nurses. All programs provide $10-25/month off plus 25% off accessories.',
    what_they_offer:
      '- $10/month off (1 phone line)\n- $25/month off (2-3 phone lines)\n- $20/month off (4+ phone lines)\n- 25% off accessories (online only)\n- Available for new and existing customers\n- Eligible groups: military/veterans, first responders, teachers, nurses',
    how_to_get_it:
      '1. Visit verizon.com/discounts to see all available programs\n2. Verify status through ID.me\n3. Military: active duty, veterans, retirees, National Guard, Reserve\n4. First responders: firefighters, EMTs/EMS, state/local police\n5. Teachers: K-12 and college/university educators\n6. Nurses: RNs, LPNs, nurse practitioners, respiratory therapists\n7. Discount continues as long as status is verified',
    timeframe: 'Ongoing',
    link_text: 'View All Discounts',
  },
  'tmobile-first-responders': {
    name: 'T-Mobile First Responders Discount',
    description:
      'T-Mobile offers special pricing on wireless plans for first responders including law enforcement, firefighters, EMTs, pensioned retirees, and families of first responders killed in line of duty.',
    what_they_offer:
      '- Essentials First Responder: $90/month for 3 lines (nearly 20% savings)\n- Go5G First Responder plans with Netflix included\n- Optional priority network access for $7.50/month\n- 40% off additional family lines\n- 5G network access',
    how_to_get_it:
      '1. Visit T-Mobile store or t-mobile.com/cell-phone-plans/first-responder-discounts\n2. Choose Essentials First Responder or Go5G First Responder plan\n3. Verify status through ID.me\n4. Eligible: state/local law enforcement, firefighters, EMTs, retirees\n5. Federal employees not eligible',
    timeframe: 'Ongoing',
    link_text: 'Learn More',
  },
  'apple-veterans-military': {
    name: 'Apple Veterans and Military Purchase Program',
    description:
      'Apple offers a 10% discount for current and veteran members of the US Military, National Guard, and Reserve. Discount also extends to immediate family members in the same household.',
    what_they_offer:
      '- 10% discount on Mac computers\n- 10% discount on iPad\n- 10% discount on accessories\n- Same warranty and service as regular purchases\n- Available to eligible family members in same household',
    how_to_get_it:
      "1. Visit Apple's Veterans and Military store online\n2. Sign in with ID.me verification\n3. Verify military or veteran status\n4. Access exclusive 10% pricing\n5. Purchase with standard Apple checkout (Apple Card Monthly Installments not available)",
    timeframe: 'Ongoing',
    link_text: 'Shop Now',
  },
  'apple-education-discount': {
    ...
    description:
      'Apple offers education pricing for college students, parents of college students, and educators at all levels, with savings of $100-400 on Mac and iPad products.',
    what_they_offer:
      '- Up to $200 off Mac computers\n- Up to $100 off iPad\n- Discounted AppleCare+\n- Free Apple Music for students (50% off)\n- Back to School bonus (June-Sept): free accessories worth up to $199',
    how_to_get_it:
      '1. Visit apple.com/us-edu/store\n2. Shop with .edu email or verify through UNiDAYS\n3. Higher education students, parents buying for students, and faculty qualify\n4. Homeschool teachers also eligible\n5. Discounted prices shown automatically in Education Store',
    timeframe: 'Ongoing (bonus accessories June-September)',
    link_text: 'Shop Education',
  },
  'att-discounts': {
    name: 'AT&T Community & Employee Discounts',
    description:
      'AT&T offers multiple discount programs including 25% off for military, veterans, retired first responders, teachers, nurses, and physicians. Additional discounts available for students, seniors 55+, AARP members, and employees of qualifying companies through Signature Hub.',
    what_they_offer:
      '**AT&T Appreciation (25% off):**\n- Military, veterans, retired first responders\n- Teachers (K-12 and college faculty)\n- Nurses, physicians, PA-Cs\n- Applies to Unlimited Premium, Extra, and Starter plans\n\n**AT&T Signature Program ($10/line/month off):**\n- Employees of qualifying companies\n- Students with .edu email\n- AARP members\n- Union members\n- Up to 5 lines, then $5/line for lines 6-10\n\n**55+ Plans:**\n- Special pricing for customers 55 and older',
    how_to_get_it:
      '1. Appreciation discounts: Visit att.com/appreciation and verify through ID.me\n2. Signature/employee discounts: Visit att.com/verification/signaturehub\n3. Students: Verify with .edu email or student ID\n4. AARP members: Verify membership status\n5. 55+: Visit att.com or AT&T store to sign up for age-verified plans\n6. Discount starts within 2-3 billing cycles',
    timeframe: 'Ongoing',
    link_text: 'View All Discounts',
  },
  'att-firstnet': {
    name: 'FirstNet by AT&T',
    description:
      "FirstNet is America's dedicated wireless network for first responders and public safety, built as a public-private partnership with the federal government. Provides priority access and dedicated bandwidth during emergencies.",
    what_they_offer:
      '- Dedicated wireless network for public safety\n- First Priority access during emergencies\n- 5G connectivity with low latency\n- Over 2.99 million square miles of coverage\n- 25% savings on family lines\n- FirstNet Fusion push-to-talk and 9-1-1 integration\n- Device financing offers available',
    how_to_get_it:
      '1. Visit firstnet.com to check eligibility\n2. Eligible: law enforcement, fire, EMS, 911 dispatchers\n3. Also eligible: healthcare providers, utilities workers, school safety\n4. Sign up online or at AT&T/FirstNet retail locations\n5. Plans start at $42.99/month for individuals\n6. Agency plans also available',
    timeframe: 'Ongoing',
    link_text: 'Check Eligibility',
  },
  'tmobile-military-discount': {
    name: 'T-Mobile Military Discount',
    description:
      'T-Mobile offers special military pricing on wireless plans for active military, veterans, and their families, with Netflix included on select plans.',
    what_they_offer:
      '- Essentials Military: $90/month for 3 lines (nearly 20% savings)\n- Go5G Military plans with Netflix included\n- Available for all consumer plans\n- Gold Star families eligible\n- Veteran-owned businesses also qualify',
    how_to_get_it:
      '1. Visit T-Mobile store or t-mobile.com/cell-phone-plans/military-discount-plans\n2. Choose Essentials Military or Go5G Military plan\n3. Verify military status\n4. Military member/veteran must be primary account holder\n5. Maintain valid military line on account',
    timeframe: 'Ongoing',
    link_text: 'Learn More',
  },
  'outback-heroes-discount': {
    name: 'Outback Steakhouse Heroes Discount',
    description:
      'Outback Steakhouse offers a 10% Heroes Discount every day for military, veterans, police, firefighters, first responders, nurses, doctors, and medical staff.',
    what_they_offer:
      '- 10% off entire check every day\n- Available for dine-in with valid ID\n- Includes military, veterans, police, firefighters\n- Also includes nurses, doctors, medical staff\n- Online orders verified through SheerID',
    how_to_get_it:
      '1. Dine in at any Outback Steakhouse location\n2. Show valid military, medical, or service ID\n3. 10% discount applied to check (excludes alcohol)\n4. Maximum one discount per table\n5. For online orders, verify through SheerID at checkout',
    timeframe: 'Ongoing (increased to 20% on some holidays)',
    link_text: 'Learn More',
  },
  'home-depot-military-discount': {
    name: 'Home Depot Military Discount',
    description:
      'Home Depot offers a 10% military discount on select in-store purchases for active duty, veterans, retirees, and eligible dependents, with a $400 annual maximum.',
    what_they_offer:
      '- 10% off select in-stock purchases\n- $400 maximum annual discount (resets each calendar year)\n- Tax-free shopping through military exchanges (expanded May 2025)\n- Available in-store and online\n- Virtual ID on Home Depot app for easy checkout',
    how_to_get_it:
      '1. Download The Home Depot app or visit homedepot.com/military\n2. Create account and verify military status through SheerID\n3. Eligible: active duty, veterans, retirees, DoD civilians, spouses\n4. Scan Virtual ID at register or enter phone number\n5. Physical military IDs no longer accepted at register',
    timeframe: 'Ongoing',
    link_text: 'Verify Status',
  },
  'lowes-military-discount': {
    ...
    description:
      "Lowe's offers a year-round 10% military discount on most full-priced items for active duty, veterans, and military spouses, with no annual limit.",
    what_they_offer:
      "- 10% off most full-priced items\n- No annual spending limit\n- Free standard shipping for verified members\n- Free upgrade to Silver Key status in MyLowe's Rewards\n- Available in-store and online",
    how_to_get_it:
      "1. Visit lowes.com/military to register\n2. Verify military status through ID.me\n3. Eligible: all US military branches, veterans, spouses\n4. Link to MyLowe's Rewards account\n5. Give phone number or MyLowe's card at checkout",
    timeframe: 'Ongoing',
    link_text: 'Verify Status',
  },
  'nike-community-discounts': {
    name: 'Nike Community Discounts',
    description:
      'Nike offers 10% off for students, military members, first responders, medical professionals, and teachers on Nike.com and in the Nike App.',
    what_they_offer:
      '- 10% off most items on Nike.com and Nike App\n- Students can reuse discount every 30 days\n- Military/first responders can reuse every 7 days\n- Nike Members also get free shipping\n- Birthday month: additional 20% off (up to 10 items)',
    how_to_get_it:
      '1. Visit nike.com/promo-code\n2. Verify status through SheerID\n3. Eligible: students, military, first responders, nurses, teachers\n4. Receive 10% off promo code after verification\n5. Reusable (frequency varies by group)',
    timeframe: 'Ongoing',
    link_text: 'Verify Status',
  },
  'under-armour-community-discount': {
    name: 'Under Armour Military & First Responder Discount',
    description:
      'Under Armour offers 20% off for military, first responders, healthcare workers, and teachers on UA.com, the UA App, and at UA Brand Houses.',
    what_they_offer:
      '- 20% off at UA.com, UA App, and Brand Houses\n- 10% off at UA Factory House stores\n- Discount may increase during promotional periods\n- Cannot combine with other promo codes\n- Freedom Collection gear available',
    how_to_get_it:
      '1. Shop on UA.com or UA App\n2. Verify status through ID.me at checkout\n3. Eligible: military, veterans, first responders, nurses, teachers\n4. In-store: show valid ID at Brand House or Factory House\n5. Discount applied automatically after verification',
    timeframe: 'Ongoing',
    link_text: 'Verify Status',
  },
  'nfl-shop-discount': {
    name: 'NFL Shop Military & First Responder Discount',
    description:
      'NFL Shop offers 15% off for military members, veterans, first responders, and their families on official NFL merchandise and gear.',
    what_they_offer:
      '- 15% off eligible purchases\n- Available to military, veterans, and first responders\n- Extends to spouses and immediate family members\n- Official NFL jerseys, apparel, and merchandise\n- Cannot combine with other promo codes',
    how_to_get_it:
      '1. Shop at NFLShop.com\n2. Add items to cart and proceed to checkout\n3. Click "Military and first responder discounts" at checkout\n4. Verify status through ID.me\n5. Discount applies automatically after verification',
    timeframe: 'Ongoing',
    link_text: 'Learn More',
  },
  'mlb-shop-discount': {
    name: 'MLB Shop Military & First Responder Discount',
    description:
      'MLB Shop offers 15% off for military members, veterans, first responders, and their families on official MLB merchandise and gear.',
    what_they_offer:
      '- 15% off eligible purchases\n- Available to military, veterans, and first responders\n- Extends to spouses and immediate family members\n- Official MLB jerseys, apparel, and merchandise\n- Cannot combine with other promo codes',
    how_to_get_it:
      '1. Shop at MLBShop.com\n2. Add items to cart and proceed to checkout\n3. Click "First Responder ID" or "Troop ID" button at checkout\n4. Verify status through ID.me\n5. Discount applies automatically after verification',
    timeframe: 'Ongoing',
    link_text: 'Learn More',
  },
  'nba-store-discount': {
    name: 'NBA Store Military & First Responder Discount',
    description:
      'NBA Store offers 15% off for military members, veterans, first responders, and their families on official NBA merchandise and gear.',
    what_they_offer:
      '- 15% off eligible purchases\n- Available to military, veterans, and first responders\n- Extends to spouses and immediate family members\n- Official NBA jerseys, apparel, and merchandise\n- Cannot combine with other promo codes',
    how_to_get_it:
      '1. Shop at store.nba.com\n2. Add items to cart and proceed to checkout\n3. Select "Military and First Responder Discount"\n4. Verify status through ID.me or SheerID\n5. Discount code applied after verification',
    timeframe: 'Ongoing',
    link_text: 'Learn More',
  },
  'nhl-shop-discount': {
    name: 'NHL Shop Military & First Responder Discount',
    description:
      'NHL Shop offers 15% off for military members, veterans, first responders, and their families on official NHL merchandise and gear.',
    what_they_offer:
      '- 15% off eligible purchases\n- Available to military, veterans, and first responders\n- Extends to spouses and immediate family members\n- Official NHL jerseys, apparel, and merchandise\n- Cannot combine with other promo codes',
    how_to_get_it:
      '1. Shop at shop.nhl.com\n2. Scroll to footer and click "Military Discount" or "First Responder Discount"\n3. Verify status through ID.me\n4. Receive unique discount code\n5. Apply code at checkout',
    timeframe: 'Ongoing',
    link_text: 'Learn More',
  },
  'microsoft-military-student-discount': {
    name: 'Microsoft Store Military & Student Discounts',
    description:
      'Microsoft Store offers 10% off select products for active military, veterans, and students, plus free Office 365 for students with a school email.',
    what_they_offer:
      '- 10% off select Surface devices, laptops, and tablets\n- Free Office 365 for students with .edu email\n- Military Appreciation Edition Microsoft 365 (~30% off through exchanges)\n- Excludes Xbox consoles, games, and gift cards\n- Online only at Microsoft Store',
    how_to_get_it:
      '1. Visit microsoft.com/en-us/store/b/military or /b/education\n2. Sign in and verify status\n3. Students: use school email for free Office 365\n4. Military: verify through store account\n5. Discounted prices shown automatically when signed in',
    timeframe: 'Ongoing',
    link_text: 'Shop Education',
  },
  'amazon-prime-student': {
    ...
    description:
      'Amazon Prime Student (now Prime for Young Adults) offers 50% off Prime membership for college students and young adults ages 18-24, with a 6-month free trial.',
    what_they_offer:
      '- 6-month free trial\n- $7.49/month or $69/year (50% off regular Prime)\n- All Prime benefits: free shipping, Prime Video, Prime Music\n- 5% cash back on select categories (limited time)\n- Eligible for up to 4 years',
    how_to_get_it:
      '1. Visit amazon.com/Amazon-Student\n2. Students: verify with .edu email or enrollment proof\n3. Ages 18-24 (non-students): verify age with ID\n4. Start 6-month free trial\n5. After trial or 4 years, converts to regular Prime pricing',
    timeframe: 'Ongoing',
    link_text: 'Start Free Trial',
  },
  'xfinity-military-program': {
    name: 'Xfinity Military Program',
    description:
      'Xfinity offers exclusive benefits for military members, veterans, and first responders including free mobile service, streaming discounts, and Visa gift cards.',
    what_they_offer:
      '- Free Unlimited Xfinity Mobile line for 24 months (with Xfinity Internet)\n- NOW TV included for 1 year (125+ live channels, Peacock Premium)\n- Peacock Premium at $3.99/mo for 1 year (normally $7.99)\n- $180 Visa Gift Card ($15/mo value for 1 year)\n- Xfinity Rewards Diamond member status\n- First responders also eligible',
    how_to_get_it:
      '1. Visit military.xfinity.com or xfinity.com/military\n2. Sign in with Xfinity ID\n3. Verify military/first responder status through ID.me or SheerID\n4. Eligible: active duty, Guard, Reserve, veterans, military families\n5. First responders: police, firefighters, EMTs, paramedics\n6. Benefits apply within 1-2 billing cycles',
    timeframe: 'Ongoing',
    link_text: 'Get Benefits',
  },
  'dish-network-military': {
    name: 'DISH Network Military & First Responder Discount',
    description:
      'DISH Network offers exclusive military and first responder packages including free Stars & Stripes channel pack, monthly movie rental, and Hopper DVR upgrade - over $500 savings over 2 years.',
    what_they_offer:
      '- Stars & Stripes channel pack FREE for 2 years ($240 value)\n- Channels include STARZ, Encore, Smithsonian, American Heroes Channel\n- Free Pay-Per-View movie rental every month\n- Free Hopper DVR upgrade (stream content anywhere)\n- 2-year price guarantee starting at $89.99/mo\n- Up to $300 gift card for new TV + Internet customers',
    how_to_get_it:
      '1. Call DISH or visit dish.com/offers/military-offer\n2. Verify military/first responder status through ID.me\n3. Eligible: active duty military, veterans, first responders\n4. First responders include firefighters, EMTs, police\n5. 2-year commitment required ($20/mo ETF if canceled early)',
    timeframe: 'Offer ends 5/13/2026',
    link_text: 'Get Military Offer',
  },
  ...
  'teacher-id-me-discounts': {
    ...
    what_they_offer:
      '- 10-25% off at major retailers\n- Classroom supply discounts (Staples, Office Depot)\n- Technology discounts (Apple, Dell, HP)\n- Entertainment and subscription savings\n- One-time verification for all retailers',
    how_to_get_it:
      '1. Create free ID.me account\n2. Verify teacher/educator status\n3. Upload school ID or employment verification\n4. Once verified, access discounts through ID.me Shop\n5. Verification works across all participating stores',
    timeframe: 'Ongoing',
    link_text: 'Verify Status',
  },
  'sf-jobsnow': {
    ...
    what_they_offer:
      '- Wage subsidies for employers who hire you\n- Job placement assistance\n- Training opportunities\n- Career coaching and support\n- Connections to Bay Area employers\n- Follow-up support after placement',
    how_to_get_it:
      "1. Visit OEWD website or local One-Stop Career Center\n2. Complete intake and assessment\n3. Meet with employment specialist\n4. Receive job placement assistance\n5. Employer receives wage subsidy when you're hired",
    timeframe: 'Ongoing',
  ...
  'the-job-forum': {
    ...
    how_to_get_it:
      '1. Visit The Job Forum website\n2. Register for weekly meetings (free)\n3. Attend workshops and networking events\n4. Connect with career coaches\n5. Access job leads and referrals',
    timeframe: 'Ongoing',
    link_text: 'Join Meetings',
  },
  'oewd-citybuild': {
    ...
    what_they_offer:
      '- Free 18-week construction training\n- Union apprenticeship placement\n- OSHA and safety certifications\n- Math and blueprint reading\n- Supportive services (transportation, tools)\n- Placement into trades (electrical, plumbing, carpentry)',
    how_to_get_it:
      '1. Attend CityBuild orientation session\n2. Complete application and interview\n3. Pass assessment tests\n4. Commit to full 18-week program\n5. Graduate and enter union apprenticeship',
    timeframe: 'Multiple cohorts annually',
    link_text: 'Apply Now',
  },
  'oewd-techsf': {
    name: 'TechSF',
    ...
    how_to_get_it:
      '1. Visit TechSF website\n2. Complete interest form\n3. Attend orientation session\n4. Apply for training programs\n5. Receive job placement support',
    timeframe: 'Ongoing',
    link_text: 'Get Started',
  },
  'meda-workforce': {
    name: 'MEDA Workforce Development',
    description:
    ...
    how_to_get_it:
      '1. Visit MEDA office in the Mission\n2. Complete intake assessment\n3. Meet with career coach\n4. Enroll in training programs\n5. Receive ongoing job search support',
    timeframe: 'Ongoing',
    link_text: 'Get Help',
  },
  'iiba-immigration': {
  ...
  'project-homeless-connect': {
    ...
    what_they_offer:
      '- Large community resource events\n- Ongoing care coordination\n- Free haircuts and hygiene items\n- Medical and dental care referrals\n- Legal services\n- Benefits enrollment assistance\n- Housing navigation',
    how_to_get_it:
      '1. Attend Project Homeless Connect events\n2. Visit their service hub for ongoing support\n3. Access free services without appointment\n4. Connect with case managers\n5. Receive referrals to housing and benefits',
    timeframe: 'Ongoing',
    link_text: 'Get Services',
  },
  ...
  'la-casa-madres': {
    ...
    description:
      "La Casa de las Madres provides comprehensive support services for individuals and families seeking safety, offering a 24/7 crisis line, emergency shelter, counseling, legal advocacy, and children's programs throughout San Francisco.",
    what_they_offer:
      '- 24/7 crisis line support\n- Emergency shelter services\n- Individual and group counseling\n- Legal advocacy and court accompaniment\n- Children and youth programs\n- Transitional housing assistance\n- Economic empowerment programs\n- Support in English and Spanish',
    how_to_get_it:
      '1. Call 24-hour crisis line: 877-503-1850\n2. Teen crisis line: 877-923-0700\n3. Text line: 415-200-3575\n4. Speak with trained advocate\n5. Receive safety planning support\n6. Access shelter and services as needed',
    timeframe: '24/7',
    link_text: 'Get Help',
  },
  'woman-inc-sf': {
    name: 'W.O.M.A.N., Inc.',
    description:
      'W.O.M.A.N., Inc. has served the San Francisco Bay Area since 1978, providing crisis intervention, counseling, advocacy, and support services for individuals experiencing unsafe home situations.',
    what_they_offer:
      '- 24-hour crisis line\n- Individual counseling sessions\n- Support groups\n- Legal advocacy\n- Safety planning\n- Latinx program with Spanish-speaking staff\n- Community education\n- Referrals to resources',
    how_to_get_it:
      '1. Call crisis line: 415-864-4722\n2. For Latinx program: 415-969-6811\n3. Email for appointments\n4. Walk-in hours available\n5. All services confidential\n6. No insurance required',
    timeframe: '24/7 crisis line',
    link_text: 'Get Support',
  },
  'safe-place-oakland': {
    name: 'A Safe Place',
    description:
      'A Safe Place provides comprehensive support services including emergency shelter, legal advocacy, counseling, and community education for individuals and families in the East Bay seeking safety.',
    what_they_offer:
      "- 24-hour crisis hotline\n- Emergency shelter\n- Legal advocacy and court support\n- Individual and group counseling\n- Children's services\n- Transitional housing\n- Community outreach and education\n- Support in multiple languages",
    how_to_get_it:
      '1. Call 24-hour hotline: 510-536-7233\n2. Speak with trained advocate\n3. Receive safety planning\n4. Access shelter if needed\n5. Connect with ongoing services\n6. All services free and confidential',
    timeframe: '24/7',
    link_text: 'Get Help',
  },
  'building-futures-alameda': {
    name: 'Building Futures',
    description:
      'Building Futures provides shelter, support services, and pathways to stability for individuals and families in Alameda County facing homelessness or unsafe home situations.',
    what_they_offer:
      "- 24-hour crisis line\n- Emergency shelter at Sister Me Home\n- Free counseling sessions\n- Court accompaniment\n- Children's programs\n- Housing navigation\n- Support groups\n- Services in English and Spanish",
    how_to_get_it:
      '1. Call crisis line: 1-866-292-9688\n2. Speak with advocate\n3. Complete intake assessment\n4. Access emergency shelter\n5. Receive ongoing case management\n6. Work toward permanent housing',
    timeframe: '24/7',
    link_text: 'Get Support',
  },
  'stand-contra-costa': {
    ...
    description:
      'STAND! provides comprehensive family safety services throughout Contra Costa County, including crisis intervention, emergency shelter, counseling, legal services, and prevention education.',
    what_they_offer:
      '- 24-hour crisis line\n- Emergency shelter\n- Individual and family counseling\n- Legal advocacy\n- Support groups\n- Youth services\n- Prevention education\n- Certified batterer intervention program',
    how_to_get_it:
      '1. Call 24-hour line: 888-215-5555\n2. Or text: 925-956-8037\n3. Speak with trained advocate\n4. Receive safety planning\n5. Access shelter and services\n6. All services confidential',
    timeframe: '24/7',
    link_text: 'Get Help',
  },
  'cora-san-mateo': {
    ...
    description:
      'CORA serves San Mateo County with comprehensive support services including a 24-hour hotline, emergency shelter, counseling, legal services, and community education programs.',
    what_they_offer:
      "- 24-hour crisis hotline\n- Emergency shelter\n- Individual and group counseling\n- Legal advocacy and restraining order help\n- Children's counseling\n- Transitional housing\n- Support in multiple languages\n- Community education",
    how_to_get_it:
      '1. Call hotline: 800-300-1080\n2. Speak with trained advocate\n3. Create safety plan together\n4. Access shelter if needed\n5. Connect with counseling\n6. Receive legal support',
    timeframe: '24/7',
    link_text: 'Get Support',
  },
  'next-door-santa-clara': {
    ...
    description:
      'Next Door Solutions provides comprehensive support services in Santa Clara County including crisis intervention, emergency shelter, counseling, legal help, and economic empowerment programs.',
    what_they_offer:
      "- 24-hour crisis hotline\n- Emergency shelter\n- Counseling services\n- Legal advocacy\n- Children's services\n- Economic empowerment\n- Support groups\n- Multilingual services",
    how_to_get_it:
      '1. Call crisis line: 408-279-2962\n2. Speak with advocate\n3. Receive safety planning\n4. Access shelter and services\n5. Connect with ongoing support\n6. All services free and confidential',
    timeframe: '24/7',
    link_text: 'Get Help',
  },
  'narika-south-asian': {
    name: 'Narika',
    description:
      'Narika provides culturally specific support services for South Asian individuals and families, offering a confidential helpline, case management, legal advocacy, and support groups in multiple South Asian languages.',
    what_they_offer:
      '- Confidential helpline\n- Case management\n- Legal advocacy\n- Support groups\n- Immigration assistance\n- Housing support\n- Services in Hindi, Urdu, Punjabi, Bengali, Tamil, and more\n- Culturally sensitive approach',
    how_to_get_it:
      '1. Call helpline: 800-215-7308\n2. Or email: narika@narika.org\n3. Speak with trained advocate\n4. Services in your language\n5. Receive culturally sensitive support\n6. Access resources and referrals',
    timeframe: 'Ongoing',
    link_text: 'Get Support',
  },
  'asian-womens-shelter': {
    ...
    description:
      "Asian Women's Shelter provides comprehensive, multilingual services including emergency shelter, counseling, legal advocacy, and support programs serving Asian and Pacific Islander communities throughout the Bay Area.",
    what_they_offer:
      "- 24-hour multilingual crisis line\n- Emergency shelter\n- Counseling services\n- Legal advocacy\n- Case management\n- Children's programs\n- Support in 40+ Asian languages\n- Immigration assistance",
    how_to_get_it:
      '1. Call crisis line: 877-751-0880\n2. Services in your language available\n3. Speak with trained advocate\n4. Receive safety planning\n5. Access shelter and services\n6. All services confidential',
    timeframe: '24/7',
    link_text: 'Get Help',
  },
  'maitri-south-bay': {
    name: 'Maitri',
    description:
      'Maitri serves South Asian families in the Bay Area, providing culturally specific support services including a helpline, emergency shelter, counseling, and legal assistance in multiple languages.',
    what_they_offer:
      '- 24-hour helpline\n- Emergency shelter\n- Case management\n- Legal advocacy\n- Counseling services\n- Support groups\n- Immigration assistance\n- Services in Hindi, Gujarati, Tamil, and more',
    how_to_get_it:
      '1. Call helpline: 888-862-4874\n2. Services in your language\n3. Speak with trained advocate\n4. Receive confidential support\n5. Access shelter if needed\n6. Connect with ongoing services',
    timeframe: '24/7',
    link_text: 'Get Support',
  },
  'family-justice-center-alameda': {
    ...
    description:
      'The Alameda County Family Justice Center brings together multiple agencies under one roof to provide comprehensive services including legal help, counseling, victim advocacy, and support for families seeking safety.',
    what_they_offer:
      "- One-stop services center\n- Legal assistance\n- Victim advocacy\n- Counseling services\n- Restraining order help\n- Immigration assistance\n- Children's services\n- Multiple agencies in one location",
    how_to_get_it:
      '1. Call: 510-267-8800\n2. Walk-in welcome during business hours\n3. Appointment recommended but not required\n4. Access multiple services in one visit\n5. All services free and confidential\n6. Interpretation available',
    timeframe: 'Mon-Fri 8:30am-5pm',
    link_text: 'Get Help',
  },
  'ywca-silicon-valley': {
  ...
  'love-is-respect': {
    ...
    description:
      'Love Is Respect provides support for young people ages 13-26 navigating relationships, offering a 24/7 helpline, text support, and online chat with trained peer advocates.',
    what_they_offer:
      '- 24/7 phone support\n- Text support (text LOVEIS to 22522)\n- Online chat\n- Peer advocates aged 18-26\n- Relationship education\n- Safety planning\n- Local resource referrals\n- Support for all genders',
    how_to_get_it:
      '1. Call: 1-866-331-9474\n2. Text LOVEIS to 22522\n3. Chat online at loveisrespect.org\n4. Peer advocates available 24/7\n5. Confidential and judgment-free\n6. No question too small',
    timeframe: '24/7',
    link_text: 'Get Support',
  },
  'amazon-prime': {
    name: 'Amazon Prime',
    description:
      'Amazon offers discounted Prime memberships for students, young adults (18-24), and qualifying government assistance recipients, with rates starting at $6.99/month.',
    what_they_offer:
      '**Prime Student & Young Adult ($7.49/month):**\n- For college students or ages 18-24\n- 6-month free trial for new student members\n- Free 2-day shipping on eligible items\n- Prime Video, Prime Music, Prime Reading included\n\n**Prime Access ($6.99/month):**\n- For recipients of qualifying government assistance\n- EBT, Medicaid, and other programs qualify\n- Same full Prime benefits\n- Re-verify eligibility every 12 months',
    how_to_get_it:
      '1. Visit amazon.com/amazonprime and choose your plan\n2. Prime Student: Verify with .edu email or enrollment documents\n3. Young Adult (18-24): Verify age through ID verification\n4. Prime Access: Verify EBT card or Medicaid status\n5. All discounted plans include full Prime benefits',
    timeframe: 'Ongoing (verify eligibility annually)',
    link_text: 'Choose Your Plan',
  },
  'spotify-student': {
    name: 'Spotify Premium Student',
    description:
      'Spotify offers college students Premium for $5.99/month (normally $11.99), including Hulu with ads and Showtime. Available for up to 4 years while enrolled.',
    what_they_offer:
      '- Spotify Premium for $5.99/month (50% off)\n- Ad-free music streaming\n- Offline listening\n- Hulu (ad-supported) included\n- Available for up to 4 years\n- Re-verify enrollment annually',
    how_to_get_it:
      '1. Visit spotify.com/us/student\n2. Verify enrollment through SheerID\n3. Must be at Title IV accredited US college/university\n4. Sign up or upgrade existing account\n5. Re-verify student status every 12 months',
    timeframe: 'Up to 4 years while enrolled',
    link_text: 'Get Premium Student',
  },
  'adobe-creative-cloud-student': {
    name: 'Adobe Creative Cloud Student Discount',
    description:
      'Adobe offers students and teachers 60% off Creative Cloud All Apps, including Photoshop, Illustrator, Premiere Pro, and 20+ creative apps for $22.99/month.',
    what_they_offer:
      '- All Creative Cloud apps for $22.99/month (60% off)\n- Includes Photoshop, Illustrator, Premiere Pro\n- Access to 20+ creative applications\n- 100GB cloud storage\n- Adobe Fonts included\n- First year pricing, then $29.99/month',
    how_to_get_it:
      '1. Visit adobe.com/creativecloud/plans\n2. Select Students & Teachers plan\n3. Verify status with school-issued email or SheerID\n4. Students ages 13+ at accredited schools eligible\n5. Teachers and faculty at all levels eligible',
    timeframe: 'Ongoing (verify annually)',
    link_text: 'Get Student Discount',
  },
  'apple-music-student': {
    name: 'Apple Music Student Plan',
    description:
      'Apple Music offers college students a discounted rate of $5.99/month (normally $10.99), including Apple TV+ for free. Available for up to 48 months while enrolled.',
    what_they_offer:
      '- Apple Music for $5.99/month (45% off)\n- Apple TV+ included at no extra cost\n- Full access to 100+ million songs\n- Ad-free listening\n- Lossless audio and spatial audio\n- Available for up to 48 months',
    how_to_get_it:
      '1. Open Apple Music app or visit music.apple.com\n2. Sign up for Student plan\n3. Verify enrollment through UNiDAYS\n4. Must be enrolled at university or college\n5. Re-verify enrollment periodically',
    timeframe: 'Up to 48 months while enrolled',
    link_text: 'Get Student Plan',
  },
  'youtube-premium-student': {
    name: 'YouTube Premium Student Plan',
    description:
      'YouTube Premium offers college students a discounted rate of $7.99/month (normally $13.99), including YouTube Music Premium, ad-free viewing, and background play.',
    what_they_offer:
      '- YouTube Premium for $7.99/month (43% off)\n- YouTube Music Premium included\n- Ad-free videos on YouTube\n- Background play on mobile\n- Video downloads for offline viewing\n- Available for up to 4 years',
    how_to_get_it:
      '1. Visit youtube.com/premium/student\n2. Sign in with Google account\n3. Verify student status through SheerID\n4. Must be at accredited higher education institution\n5. Re-verify enrollment annually',
    timeframe: 'Up to 4 years while enrolled',
    link_text: 'Get Student Plan',
  },
  'hulu-student': {
    name: 'Hulu Student Discount',
    description:
      'Hulu offers college students the ad-supported plan for $1.99/month (normally $9.99), a savings of 80%. Available through SheerID verification.',
    what_they_offer:
      '- Hulu (ad-supported) for $1.99/month\n- 80% off regular price\n- Full streaming library access\n- Watch on multiple devices\n- Available for up to 4 years',
    how_to_get_it:
      '1. Visit hulu.com/student\n2. Verify enrollment through SheerID\n3. Must be enrolled at US Title IV college\n4. New and returning subscribers eligible\n5. Re-verify student status annually',
    timeframe: 'Up to 4 years while enrolled',
    link_text: 'Get Student Discount',
  },
