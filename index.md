...
| Program | Area | Eligibility | Benefit | How to Use It | Timeframe | Link |
|--------|------|-------------|---------|---------------|-----------|------|
| ACT Fee Waivers | Nationwide | 💳 | Receive two free ACT tests (including optional science/writing); free access to official ACT Self-Paced Course (Kaplan); send scores to up to 20 colleges; can request college application fee waivers | Request through your high school counselor | Ongoing | [ACT Fee Waivers](https://www.act.org/content/act/en/products-and-services/the-act/registration/fees/fee-waivers.html) |
...
| Internet Essentials by Xfinity | Nationwide | 💳 | Affordable home internet + Wi-Fi modem | Apply online or call | Ongoing | [Internet Essentials](https://www.xfinity.com/learn/internet-service/internet-essentials) |
